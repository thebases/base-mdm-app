...
import com.base.launcher.util.ConnectionWaiter;
...
import com.base.launcher.worker.PushNotificationWorker;
import com.base.launcher.worker.ScheduledAppUpdateWorker;
...
public class Initializer {
    ...
    public static void startServicesAndLoadConfig(Context context) {
        ...
        // Not allowed to start service Intent { cmp=com.base.launcher/.service.StatusControlService }: app is in background
