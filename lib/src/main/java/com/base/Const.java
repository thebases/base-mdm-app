...
class Const {
    ...
    static final String LEGACY_PACKAGE = "com.base.kiosk";
    ...
    public static final int BASE_RECONNECT_DELAY_FIRST = 5000;
    public static final int BASE_RECONNECT_DELAY_NEXT = 60000;
}
